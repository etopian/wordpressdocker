...
### Our Product
A bit of shameless self-promotion. We are building a freemium Docker hosting control panel which does everything taught in this tutorial automatically and much more, backups, staging/dev/prod, code editor, github/bitbucket, DNS, **WordPress Management like ManageWP**, etc. For example deploy 10 WordPress sites on a $5 Digital Ocean Droplet in around 10 minutes. Save $95 compared to WPEngine!. Sign up for [http://www.devoply.com](http://www.devoply.com) and make your life much easier!
