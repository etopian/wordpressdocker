...
### Our Product
A bit of shameless self-promotion. We are building a Docker hosting control panel which does all of this on its own and more, backupes, DNS, etc. It's called DEVOPly. And we are looking for beta-testers. Go to http://www.devoply.com to sign up.
